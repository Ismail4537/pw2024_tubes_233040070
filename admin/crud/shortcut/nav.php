        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="index.php">Tabel hardware</a></li>
                        <li><a class="dropdown-item" href="#">Tabel harga</a></li>
                        <?php
                    ...
                    <li>
                        ...
                        <li><a class='dropdown-item' href='users.php'>Tabel user</a></li>
                    ";
                        }
                        ?>
                    </ul>
            ...
            <div class="d-flex justify-content-evenly">
                <a href="http://localhost/pw2024_tubes_233040070/admin/crud/user.php" class="d-flex btn btn-sm btn-primary justify-content-center me-2">
                    <div class="fs-5 me-2"><?= $tampil_user['username'] ?></div><img class="rounded-circle" src="http://localhost/pw2024_tubes_233040070/admin/crud/gambar_profile/<?= $gambar_profile; ?>" alt="Profile_picture.png" style="height:30px; width: 30px;">
                </a>
