...
<div class="tableku">
    <table class="text-center table table-bordered table-hover table-responsive table-sm">
        ...
        <?php
        $sort1 = isset($_POST['sort1']) ? $_POST['sort1'] : "id";
        $sort2 = isset($_POST['sort2']) ? $_POST['sort2'] : "ASC";
        $cari1 = isset($_POST['cari1']) ? $_POST['cari1'] : "";
        $cari2 = isset($_POST['cari2']) ? $_POST['cari2'] : "username";
        $limit = isset($_POST['limit']) ? $_POST['limit'] : 10;
        $page = isset($_POST['page']) ? $_POST['page'] : 1;
        $limit_start = ($page - 1) * $limit;
        $limit_start = ($limit_start < 0) ? 0 : $limit_start;
        $data = search_single("user", $sort1, $sort2, $cari1, $cari2, $limit_start, $limit);
    ...
    <div>
        <?php
        $query_jumlah = "SELECT COUNT(*) AS jumlah FROM user WHERE $cari2 LIKE '%" . $cari1 . "%'";
